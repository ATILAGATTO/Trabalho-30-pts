...
<body class="bg-dark text-white">
  <div class="card border border-4  border-light bg-dark text-white text-center position-absolute top-50 start-50 translate-middle">
    ...
    <form action="cad.php" method="post"  name="frmCdaCliente" enctype="multipart/form-data">
      <div class="card-body border border-light">
        ...
        <div class="mb-3">
          <label for="whatsappAdd" class="form-label">Contato</label>
          <input type="text" class="form-control" name="whatsappAdd" id="whatsappAdd">
        </div>
        <div class="mb-3">
          <label for="senha" class="form-label">Senha</label>
          <input type="password" class="form-control" id="senhaAdd" name="senhaAdd">
        </div>
      </div>
