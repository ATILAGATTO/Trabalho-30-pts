...
<body class="bgbody">
    ...
    <nav class="navbar navbar-expand-lg bg-warning navBar fixed-top mb-5 fonte ">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="cadastro.php" <?php if(isset($idUsuarioSession)){echo('style="display: none"');} ?>>Cadastre-se</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.php" <?php if(isset($idUsuarioSession)){echo('style="display: none"');} ?>>Login</a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" <?php if(empty($idUsuarioSession)){echo('style="display: none"');} ?> href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Nome do user
                        </a>
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-3">
        <?php
                $banner = listarTabela('idbanner, foto, cadastro, alteracao, ativo', 'banner', 'idbanner');
                if ($banner != 'Vazio') {
            ...
            ?>
            <img src="./img/<?php echo $foto; ?>" class="card-img-top banner" alt="...">
            <?php
                    }}
            ?>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 mt-3">
                <div class="card" style="width: 18rem;">
                    <a href="telaproduto.php?&id=<?php echo $idProdutos?>">
